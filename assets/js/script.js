...
var typed = new Typed(".typing-text", {
    strings: ["Data science", "Machine learning", "Data analytic", "Feature Engeneering", "Web Mining"],
    loop: true,
    typeSpeed: 50,
    backSpeed: 25,
    backDelay: 500,
...
btn.addEventListener("click", (e) => {
    ...
    var phonePattern = /^\+?\d{1,15}$|^0\d{1,15}$/;
    ...
    if (isValid) {
        ...
        api.onload = function() {
            if (api.status >= 200 && api.status < 300) {
                alert("Message sent to RERHAY Ikram. Thank you!");
            } else {
